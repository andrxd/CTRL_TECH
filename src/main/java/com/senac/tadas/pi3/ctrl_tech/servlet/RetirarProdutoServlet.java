 ...
 * @author Andre
 */
@WebServlet(name = "RetirarProdutoServlet", urlPatterns = {"/RetirarProdutoServlet"})
public class RetirarProdutoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int qtdRetirar = Integer.parseInt(request.getParameter("qtdRetirar"));
        ...
        if (qtdAtual >= 0) {
            try {
                ...
                dao.registrar(usuario, prod, qtdRetirar, "RETIRADA");
